package com.mart.sszx.common.util;
...
public class SmartLocalDateUtil {
    ...
    public static void main(String[] args) {
        System.out.println(format(LocalDateTime.now(), SmartDateFormatterEnum.YMD_HMS));
        System.out.println(format(LocalDateTime.now(), SmartDateFormatterEnum.YMD_HM));
